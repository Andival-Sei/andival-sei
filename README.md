...
- ✅ **Shadcn/ui** - доступные и кастомизируемые UI компоненты
...
- [Shadcn/ui Documentation](https://ui.shadcn.com/) - документация UI компонентов
...
- **Button** - кнопка с вариантами (default, outline, ghost, destructive, secondary, link)
- **Card** - карточка с подкомпонентами (CardHeader, CardTitle, CardDescription, CardContent, CardFooter)
- **Input**, **Textarea**, **Label** - компоненты форм
...
Все компоненты доступны через импорт из `@/src/shared/ui`:
...
- [x] Интегрировать Shadcn/ui
- [x] Реализовать переключатель темы
- [ ] Добавить контент на страницы
- [ ] Реализовать форму обратной связи (компоненты готовы)
